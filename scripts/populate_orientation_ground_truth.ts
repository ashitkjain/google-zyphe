...
const TESTER_DATA: TesterRow[] = [
    ...
    { address: '4416 Comanche Way, Pleasanton, CA 94588 US',       remark: 'Bad',  expected_orientation: 'South',     tester_notes: 'The property do not face Northeast (~45°) it is bit difficult to tell but the front door might face towards South based on photos and satellite imagery' },
    { address: '3074 Boardwalk St, Pleasanton, CA 94588 US',      remark: 'Bad',  expected_orientation: 'Northwest', tester_notes: 'the property do not face North it faces northwest' },
    { address: '4350 Columbine Dr, Pleasanton, CA 94588 US',      remark: 'Bad',  expected_orientation: 'Northeast', tester_notes: 'the property do not face North it faces East/Northeast' },
    { address: '7449 Muirwood Ct, Pleasanton, CA 94588 US',       remark: 'Good', expected_orientation: 'South',     tester_notes: 'The property do face south' },
    { address: '7880 La Quinta Ct, Pleasanton, CA 94588 US',      remark: '',     expected_orientation: null,        tester_notes: "the property's Front Orientation displays UNCLEAR" },
    { address: '4093 Alta Ct, Pleasanton, CA 94588 US',           remark: '',     expected_orientation: null,        tester_notes: "the property's Front Orientation displays UNCLEAR" },
    { address: '7830 Medinah Ct, Pleasanton, CA 94588 US',        remark: 'Good', expected_orientation: 'Northwest', tester_notes: 'the property do not face North it faces northwest' },
    { address: '3341 Sorrel Downs Ct, Pleasanton, CA 94588 US',   remark: 'Bad',  expected_orientation: 'North',     tester_notes: 'The property do not face Northeast it faces North' },
    { address: '8509 Lupine Ct, Pleasanton, CA 94588 US',         remark: '',     expected_orientation: null,        tester_notes: "the property's Front Orientation displays UNCLEAR" },
    { address: '3671 Platt Ct S, Pleasanton, CA 94588 US',        remark: 'Bad',  expected_orientation: 'West',      tester_notes: 'The property do not face north it faces west' },
    { address: '3002 Tonopah Cir, Pleasanton, CA 94588 US',       remark: 'Bad',  expected_orientation: 'East',      tester_notes: 'The property do not face Northwest it faces East' },
    { address: '1296 Vintner Way, Pleasanton, CA 94566 US',       remark: '',     expected_orientation: null,        tester_notes: "the property's Front Orientation displays UNCLEAR" },
    { address: '4286 Garibaldi Pl, Pleasanton, CA 94566 US',      remark: 'Bad',  expected_orientation: 'Northwest', tester_notes: 'the property do not face Northeast it faces northwest based on images' },
    { address: '665 Palomino Dr Unit D, Pleasanton, CA 94566 US', remark: '',     expected_orientation: null,        tester_notes: 'difficult to determine the front door orientation though street view is available the property is on the bsck side of a single housing building' },
    { address: '581 Tawny Dr, Pleasanton, CA 94566 US',           remark: 'Good', expected_orientation: 'North',     tester_notes: 'The property do face North' },
    { address: '775 Bonde Ct, Pleasanton, CA 94566 US',           remark: 'Good', expected_orientation: 'North',     tester_notes: 'The property do face North' },
    { address: '733 Vineyard Ter, Pleasanton, CA 94566 US',       remark: 'Bad',  expected_orientation: 'Southeast', tester_notes: 'The proeprty do not face north it faces Southeast' },
    { address: '2223 Camino Brazos, Pleasanton, CA 94566 US',     remark: 'Bad',  expected_orientation: 'South',     tester_notes: 'The property do not face north it faces south' },
    { address: '1647 Harvest Rd, Pleasanton, CA 94566 US',        remark: '',     expected_orientation: null,        tester_notes: 'less data available for the property' },
    { address: '5550 Black Ave, Pleasanton, CA 94566 US',         remark: '',     expected_orientation: null,        tester_notes: 'less data available for the property' },
    { address: '150 Trenton Cir, Pleasanton, CA 94566 US',        remark: 'Bad',  expected_orientation: 'North',     tester_notes: 'The property do not face Northeast it faces North' },
    { address: '4767 Del Valle Pkwy, Pleasanton, CA 94566 US',    remark: 'Bad',  expected_orientation: 'South',     tester_notes: 'The property do not face Northeast it faces south' },
    { address: '1164 Tiffany Ln, Pleasanton, CA 94566 US',        remark: 'Bad',  expected_orientation: 'Southeast', tester_notes: 'The property do not face Northwest it faces southeast' },
    { address: '5484 San Jose Dr, Pleasanton, CA 94566 US',       remark: 'Bad',  expected_orientation: 'South',     tester_notes: 'The property do not face North it faces south' },
    { address: '4452 Del Valle Pkwy, Pleasanton, CA 94566 US',    remark: '',     expected_orientation: null,        tester_notes: 'the front door orientation is difficult to determine' },
    { address: '1144 Harvest Rd, Pleasanton, CA 94566 US',        remark: 'Good', expected_orientation: 'North',     tester_notes: 'The property do face north' },
    { address: '2865 Longspur Way, Pleasanton, CA 94566 US',      remark: 'Good', expected_orientation: 'North',     tester_notes: 'The property do face north' },
    { address: '646 Windmill Ln, Pleasanton, CA 94566 US',        remark: '',     expected_orientation: null,        tester_notes: "the property's Front Orientation displays UNCLEAR" },
    { address: '2383 Silver Oaks Ln, Pleasanton, CA 94566 US',     remark: '',     expected_orientation: null,        tester_notes: "the property's Front Orientation displays UNCLEAR" },
    { address: '2426 Tapestry Way, Pleasanton, CA 94566 US',      remark: 'Good', expected_orientation: 'East',      tester_notes: 'The property do face East' },
];
