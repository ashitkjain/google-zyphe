...
export const PROPERTY_TAXONOMY: PropertyTag[] = [
    ...
    { id: 'sub_zero_wolf', label: 'Sub-Zero / Wolf', zone: 'culinary', category: 'kitchen_appliances', aliases: ['Sub-Zero refrigerator', 'Wolf range', 'Wolf cooktop', 'Sub-Zero fridge'] },
    { id: 'miele_appliances', label: 'Miele Appliances', zone: 'culinary', category: 'kitchen_appliances', aliases: ['Miele dishwasher', 'Miele oven', 'Miele cooktop', 'Miele range'] },
