...
export const biddingStrategyPrompt = (property: PropertyData) => {
    ...
    return `Act as a Data-Driven Real Estate Consultant. I am evaluating a property at **${address}** and need a Bidding Strategy Report based on current January 2026 market data. Please search for and provide the following:
...
Present this in a structured report for a buyer to use in a professional negotiation.

You MUST respond in strict JSON format using this structure:
{
  "property_specifics": {
