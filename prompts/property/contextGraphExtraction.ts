...
26. **Kitchen Profile**: Combines caliber ("Chef's"), materials ("Quartz counters"), and appliance pedigree. From visualAnalysis.room_highlights or listingDescription. If ANY of these top-tier appliance brands are mentioned — Sub-Zero, Wolf, Miele, Thermador, Viking, Gaggenau, Bosch Benchmark, Dacor, JennAir, Monogram, Fisher & Paykel, La Cornue, Lacanche, ILVE, KitchenAid Pro, Smeg, Cove, Asko — OR any phrase like "professional grade", "chef's appliances", "high-end appliances", "luxury appliances", or "commercial grade" — emit the canonical tag "Premium Appliance Brand" (and put the specific brand name in another tag if known, e.g. "Wolf range and Sub-Zero fridge"). Do NOT enumerate brands as separate per-brand tags — one "Premium Appliance Brand" tag is enough.
