...
26. **Kitchen Profile**: Combines caliber ("Chef's"), materials ("Quartz counters"), and appliance pedigree. From visualAnalysis.room_highlights or listingDescription. If any top-tier luxury or professional appliance brands are mentioned, or phrases like "professional grade", "chef's appliances", "high-end appliances" — emit the canonical tag "Premium Appliance Brand" (and put the specific brand name in another tag if known). Do NOT enumerate brands as separate per-brand tags — one "Premium Appliance Brand" tag is enough.
