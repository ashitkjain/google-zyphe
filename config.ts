...
export const APP_CONFIG = {
    ...
    roleTabs: {
        ...
        auditor: ['interior', 'rooms', 'exterior_and_neighborhood', 'neighborhood', 'pulse', 'deep_research', 'context_graph'],
        admin: ['interior', 'rooms', 'exterior_and_neighborhood', 'neighborhood', 'pulse', 'image_analysis', 'investment', 'quality', 'deep_research', 'context_graph'],
    },
    rapidapi: {
        realtyInUsApi: {
