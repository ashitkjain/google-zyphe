...
export const APP_CONFIG = {
    ...
    roleTabs: {
        ...
        investor: ['interior', 'rooms', 'exterior_and_neighborhood', 'neighborhood', 'pulse', 'image_analysis', 'investment', 'quality', 'storage_registry', 'market_analysis', 'opportunity_discovery', 'industry_research', 'product_market_fit', 'post_close_intelligence', 'technical_papers']
    },
    rapidapi: {
        realtyInUsApi: {
