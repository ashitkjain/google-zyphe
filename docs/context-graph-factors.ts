...
export const CONTEXT_GRAPH_FACTORS: DecisionFactor[] = [
    ...
    },
    {
        ...
        dataSource: 'property.google_places.walkable (Google Places API, 1.5km radius)',
    ...
    },
    {
        ...
        nodeLabel: 'AmenityDensity',
        dataSource: 'property.google_places.drivable.medical (Google Places API, 5km radius)',
    ...
    },
    {
        ...
        nodeLabel: 'AmenityDensity',
        dataSource: 'property.google_places.transit (electric_vehicle_charging_station type)',
    ...
    },
    {
        ...
        nodeLabel: 'CommunityVibe',
        dataSource: 'google_places.parks + property.resoFacts.fencing + lifestyle_insights.pets',
    ...
    },
    {
        ...
        nodeLabel: 'AmenityDensity',
        dataSource: 'google_places.walkable.dining (Google Places API, 1.5km radius)',
