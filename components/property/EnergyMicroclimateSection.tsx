...
const EnergyMicroclimateSection: React.FC<Props> = ({ data, micro }) => {
    ...
    return (
        <div className="bg-white px-6 pt-6 pb-6 rounded-2xl border-2 border-slate-100 overflow-visible mb-6">
                ...
                <div className="w-7 h-7 rounded-lg bg-yellow-100 flex items-center justify-center">
                    <i className="fa-solid fa-solar-panel text-yellow-600 text-[11px]"></i>
                </div>
                <span className="text-lg font-black text-slate-900 tracking-tight">Energy & Microclimate</span>
            </div>
...
export default EnergyMicroclimateSection;
