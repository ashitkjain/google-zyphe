                ...
                <div className="bg-white rounded-3xl border border-slate-200/60 p-8 shadow-sm space-y-6">
                    <div>
                        ...
                        <p className="text-[13px] font-medium text-slate-500 mt-1">
                            Road noise propagation across {city} — derived from OpenStreetMap road network.
                        </p>
                    </div>
                    ...
                    <div className="h-[420px] rounded-2xl overflow-hidden border border-slate-200 relative">
                        ...
                        {/* Legend */}
                        <div className="absolute bottom-6 right-6 bg-white/92 backdrop-blur-md p-4 rounded-2xl border border-slate-200 shadow-xl z-10 pointer-events-none">
