    ...
    return (
        <div id="ov-lifestyle" className="flex flex-col gap-1 w-full scroll-mt-20 select-none">
            <div className="flex flex-col xl:flex-row gap-8 w-full">
                            ...
                            {(() => {
                                ...
                                return (
                                    <div className="flex flex-col gap-3">
                                        <p className="text-[13px] text-slate-700 leading-relaxed font-sans font-medium">{fitData.summary}</p>
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                            {fitData.strengths?.length > 0 && (
                                                <div className="bg-emerald-50 border border-emerald-100 rounded-xl p-4 shadow-sm">
                                                    <div className="text-[9px] font-black text-emerald-600 uppercase tracking-widest mb-3 flex items-center gap-2">
                ...
                {/* Interests */}
                <div className="xl:flex-1 flex flex-col bg-slate-50 rounded-2xl border-2 border-indigo-200 overflow-hidden hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
                    <div className="p-3 flex-1 flex flex-col">
                        <div className="flex items-center gap-3 mb-4">
                        ...
                        <div className="flex-1 bg-white rounded-xl border border-slate-100 shadow-sm overflow-hidden p-4">
                            {(() => {
                                ...
                                return (
                                    <p className="text-[13px] text-slate-700 leading-relaxed text-left font-sans font-medium">
