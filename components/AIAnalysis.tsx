  ...
  if (loading) {
    return (
      <div className="bg-blue-50 border border-blue-100 rounded-xl p-10 text-center">
        ...
        <p className="text-blue-800 text-lg font-bold">Gemini is performing deep intelligent analysis...</p>
      </div>
    );
  }
  ...
  return (
    <div className="mt-10 space-y-8">
      <div className="flex items-center space-x-4 mb-4">
        ...
        <h2 className="text-3xl font-bold bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent">PropIntel™ AI Deep Analysis</h2>
      </div>
        ...
        {sections.map((s, idx) => (
          <div key={idx} className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 hover:shadow-md transition-shadow group">
            <div className="flex items-center mb-5">
              ...
              <h3 className={`font-bold text-gray-800 text-xl`}>{s.title}</h3>
            </div>
