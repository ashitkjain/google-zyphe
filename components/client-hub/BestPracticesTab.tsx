...
type Section = 'timings' | 'buyer_agent' | 'seller_agent' | 'communication' | 'listing_marketing' | 'pricing_negotiation' | 'lead_generation' | 'systems_productivity' | 'transaction_compliance' | 'education_positioning' | 'branding_development' | 'market_analytics';
