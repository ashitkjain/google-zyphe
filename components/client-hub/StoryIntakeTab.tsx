                ...
                <div style={{
                    ...
                    <div style={{ position: 'relative' }}>
                        ...
                        <p style={{ fontSize: 15.5, color: 'rgba(255,255,255,0.78)', lineHeight: 1.55, maxWidth: 720, margin: 0 }}>
                            Skip the filter checkboxes. Describe your life — your household, your rituals, your must-haves —
                        ...
                        <div style={{ display: 'flex', gap: 28, marginTop: 24 }}>
                            {[
                                { n: '5 prompts', s: '~6 minutes' },
                                { n: 'AI fit score', s: 'per home' },
                                { n: 'Editable', s: 'refine anytime' },
                            ].map(x => (
                                <div key={x.n} style={{ display: 'flex', flexDirection: 'column' }}>
                                    <span style={{ fontFamily: 'var(--font-serif, Georgia, serif)', fontSize: 22, fontWeight: 500, color: '#fff', letterSpacing: '-0.01em' }}>{x.n}</span>
                                    <span style={{ fontSize: 11, letterSpacing: '0.14em', textTransform: 'uppercase', color: '#a78bfa', fontWeight: 700, marginTop: 2 }}>{x.s}</span>
                                </div>
                            ))}
                        </div>
                    </div>
