    ...
    <div className="space-y-8 text-slate-600 bg-white p-8 md:p-12 rounded-[2rem] border border-slate-200 shadow-sm">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 pb-8 border-b border-slate-100">
            <div className="p-4 bg-indigo-50 rounded-xl border border-indigo-100">
                ...
                <div className="text-xs text-slate-900 font-bold">Data should not have to be re-entered</div>
            </div>
            <div className="p-4 bg-indigo-50 rounded-xl border border-indigo-100">
                <div className="text-[10px] font-black text-indigo-600 uppercase mb-2">Key Takeaway #2</div>
                <div className="text-xs text-slate-900 font-bold">Agents want to run their entire business via voice</div>
            </div>
            <div className="p-4 bg-indigo-50 rounded-xl border border-indigo-100">
                <div className="text-[10px] font-black text-indigo-600 uppercase mb-2">Key Takeaway #3</div>
                <div className="text-xs text-slate-900 font-bold">Visual delighterful experience matters ("Pinterest style collaborative cards")</div>
            </div>
        </div>
        ...
        <section className="space-y-4">
            <h3 className="text-lg font-black text-slate-900 uppercase tracking-wider">The Challenge: The "Integration Tax"</h3>
            <p className="text-sm leading-relaxed text-slate-600">
        ...
        <section className="space-y-6">
            <h3 className="text-lg font-black text-slate-900 uppercase tracking-wider">The Strategy: The "End-to-End" Ecosystem</h3>
            <div className="space-y-6">
                <div className="p-6 bg-slate-50 rounded-2xl border border-slate-100 space-y-3">
                    <h4 className="font-black text-slate-900 text-sm">1. Unified Data Fabric</h4>
                ...
                <div className="p-6 bg-slate-50 rounded-2xl border border-slate-100 space-y-4">
                    <h4 className="font-black text-slate-900 text-sm">2. Agentic AI & Predictive Analytics</h4>
                    <div className="grid md:grid-cols-2 gap-4">
                        <div className="space-y-2">
                            <div className="text-[10px] font-black text-indigo-600 uppercase">"Likely to Sell" Model</div>
                            <p className="text-xs text-slate-500 italic">Analyzes homeowner behavior (market trends, public records, social cues) to predict listings. Agents using this tool doubled their commission revenue.</p>
                        </div>
                        <div className="space-y-2">
            ...
            <div className="overflow-hidden rounded-2xl border border-slate-200">
                <table className="w-full text-left text-xs">
                    ...
                    <tbody className="divide-y divide-slate-100">
                        <tr>
                            <td className="p-4 text-slate-900 font-bold">Agent Productivity</td>
                            <td className="p-4 text-slate-500">20% increase in deals closed per agent</td>
                        </tr>
                        <tr>
                            <td className="p-4 text-slate-900 font-bold">Time-to-Sale</td>
                            <td className="p-4 text-slate-500">15% faster than market average</td>
                        </tr>
                        <tr>
                            <td className="p-4 text-slate-900 font-bold">Revenue (Q2 2025)</td>
                            <td className="p-4 text-indigo-600 font-black">$2.06 Billion (up 21.1% YoY)</td>
                        </tr>
                    </tbody>
                </table>
            </div>
