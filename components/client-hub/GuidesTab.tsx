...
// ─── Static content: Architectural Styles ────────────────────────────────────
const ARCH_STYLES_SLUG = 'residential-architectural-styles';
        ...
        styles: [
            {
                ...
                identifiers: ['Centered front door with equal windows on each side', 'Typically two stories with steep gabled roof', 'Rectangular shape, formal proportion', 'Shutters and a classic entryway pediment'],
                description: 'Colonial homes are the quintessential American style, defined by their perfect bilateral symmetry. A centered front door is flanked by an equal number of windows on either side. Most are two stories with a steep gabled roof.'
            },
            {
                name: 'Victorian',
                ...
                identifiers: ['"Gingerbread" decorative trim along gables and porches', 'Wraparound porch, steep multi-faceted roofline', 'A cylindrical tower or turret on one corner', 'Bold multi-color paint schemes ("Painted Ladies")'],
                description: 'Victorian homes are known for being ornate and whimsical. You\'ll see \'gingerbread\' trim, wraparound porches, steep roof pitches, and often a cylindrical tower or turret. They embrace asymmetry and decorative excess.'
            },
            {
                name: 'Greek Revival',
                ...
                identifiers: ['Large white columns (pillars) across the full façade', 'Triangular pediment above the front porch', 'Low-pitched roof, wide frieze board', 'Symmetrical plan mimicking a Greek temple'],
                description: 'Greek Revival homes mimic an ancient Greek temple. They are identifiable by their large white columns and a triangular pediment above the front porch entrance. Popular in the antebellum South.'
            },
        ]
    },
    {
        ...
        styles: [
            {
                ...
                identifiers: ['Wide overhanging eaves with exposed wooden rafter tails (brackets)', 'Heavy tapered porch columns resting on stone or brick piers', 'Low-pitched gabled roof, often with dormers', 'Built-in cabinetry and natural wood interior detailing'],
                description: 'Craftsman homes celebrate hand-crafted quality and natural materials. They feature low-slung gabled roofs with wide overhanging eaves, exposed wooden rafters (brackets), and heavy tapered porch columns.'
            },
            {
                name: 'Tudor',
                ...
                identifiers: ['Exposed dark wood beams set against light-colored stucco — "half-timbering"', 'Steeply pitched gable roofline, sometimes with multiple cross-gables', 'Tall, narrow windows, often with diamond-paned glass', 'Arched doorways with decorative stonework'],
                description: 'Tudor homes are inspired by late medieval English architecture. They are easily recognized by half-timbering — exposed dark wood beams against light-colored stucco or brick. Steeply pitched rooflines and tall narrow windows complete the look.'
            },
            {
                name: 'Cape Cod',
                ...
                identifiers: ['1.5 stories with "dormer" windows poking out of the roofline', 'Simple symmetrical façade, centered front door', 'Steep gabled roof, often with wood shingles', 'Minimal ornamentation, practical and compact design'],
                description: 'Cape Cod is a quintessential American style — simple, symmetrical, and usually 1.5 stories. Dormer windows pop out of the steeply pitched roof to add light and usable headroom to the upper half-story.'
            },
        ]
    },
    {
        ...
        styles: [
            {
                ...
                identifiers: ['Red barrel clay tile roof — the single most distinctive identifier', 'White or cream stucco exterior walls', 'Arched doorways and windows with wrought-iron accents', 'Heavy carved-wood doors, inner courtyard or fountain'],
                description: 'Spanish Colonial homes are distinguishable by their red clay tile roofs, white stucco walls, and arched doorways. They often feature heavy carved-wood doors, wrought-iron accents, and interior courtyards that invite outdoor living.'
            },
            {
                ...
                identifiers: ['High, steeply pitched "hipped" roof — sloping on all four sides', 'Tall, narrow arched windows that break through the roofline', 'Formal, symmetrical façade with refined detailing', 'Mansard-style upper story windows'],
                description: 'French Provincial homes are characterized by high, steeply pitched hipped roofs and tall, arched windows that often break through the roofline itself. The overall effect is formal, refined, and château-inspired.'
            },
            {
                name: 'Pueblo Revival',
                ...
                identifiers: ['Rounded earth-colored walls with an organic, hand-sculpted look', 'Flat or slightly sloped roof with "vigas" — wooden beams poking through the exterior', 'Stepped rooflines, portal (covered porch), and kiva fireplaces', 'Indigenous Southwest palette: terracotta, sand, and adobe brown'],
                description: 'Common in the Southwest, Pueblo Revival homes use rounded earth-colored walls, flat roofs, and vigas — wooden beams that stick through the exterior walls. The style celebrates indigenous Southwestern building traditions.'
            },
        ]
    },
    {
        ...
        styles: [
            {
                ...
                identifiers: ['Flat or "butterfly" roofline (sloping inward to center)', 'Floor-to-ceiling glass windows and walls — bringing the outside in', 'Open floor plans, post-and-beam construction', 'Integration with landscape; often uses natural wood and stone accents'],
                description: 'Popularized from 1945–1965, Mid-Century Modern homes focus on connecting indoors to outdoors. They feature flat or butterfly roofs, walls of glass, open floor plans, and a strong horizontal emphasis.'
            },
            {
                name: 'Contemporary',
                ...
                identifiers: ['Asymmetrical shapes and bold geometric forms', 'Industrial elements: exposed steel, concrete, and large-format materials', 'Large, often irregularly placed windows', 'Sustainable features: solar panels, green roofs, passive design'],
                description: 'Contemporary is a broad term for homes built today that use sustainable materials, asymmetrical shapes, and industrial elements like steel and concrete. Unlike "Modern," it is not a fixed period — it evolves continuously.'
            },
            {
                ...
                identifiers: ['White vertical "board and batten" siding — the defining exterior cladding', 'Black window frames and black hardware accents', 'A large metal-roofed front porch with exposed beams', 'Clean gabled roofline blending rustic and contemporary details'],
                description: 'Modern Farmhouse blends the traditional rural gable-roofed barn aesthetic with contemporary updates. Key indicators are white board-and-batten siding, black window frames, and a large covered porch — all with a clean, uncluttered feel.'
            },
        ]
    },
];
...
const GuidesTab: React.FC<GuidesTabProps> = ({ onNavigate }) => {
    ...
    const handleViewGuide = async (guide: GuideItem, categoryOverride?: GuideCategory) => {
        ...
        if (guide.slug === ARCH_STYLES_SLUG) {
            setGuideContent('__ARCH_STYLES_STATIC__');
                    ...
                    <div className="max-w-5xl mx-auto px-10 py-12 pb-20">
                        ...
                        {loadingContent ? (
                            ...
                            <article className="prose prose-slate prose-lg max-w-none">
                                {guideContent === '__ARCH_STYLES_STATIC__' ? (
                                    <div className="space-y-16">
                                        ...
                                        <div className="relative rounded-[2rem] overflow-hidden bg-gradient-to-br from-slate-900 to-slate-800 p-10 md:p-14 text-white">
                                            ...
                                            <div className="relative z-10 max-w-2xl">
                                                ...
                                                <p className="text-slate-300 text-lg leading-relaxed font-medium">
                                                    Residential architecture is a visual language that tells the story of a region's history, climate, and culture.
                                                    While many modern homes are "eclectic," most fall into several distinct categories — each with signature identifiers.
                                                </p>
                                            </div>
                                        </div>
                                        ...
                                        {ARCH_STYLE_GROUPS.map(group => {
                                            const colorMap: Record<string, { bg: string, badge: string, border: string, icon: string, text: string }> = {
                                                            ...
                                                            <div key={style.name} className="bg-white border border-slate-100 rounded-[1.75rem] overflow-hidden shadow-sm hover:shadow-lg hover:border-slate-200 transition-all duration-300 group">
                                                                ...
                                                                <div className="px-6 pb-4 grid grid-cols-1 gap-2">
                                                                    <div className="flex items-start gap-2 bg-slate-50 rounded-xl p-3">
                                                                        <i className="fa-solid fa-bricks text-slate-400 text-xs mt-0.5" />
                                                                        <div>
                                                                            <div className="text-[9px] font-black uppercase tracking-widest text-slate-400">Material</div>
                                                                            <div className="text-xs font-bold text-slate-700">{style.material}</div>
                                                                        </div>
                                                                    </div>
                                                                    <div className="flex items-start gap-2 bg-slate-50 rounded-xl p-3">
                                                                        <i className="fa-solid fa-house text-slate-400 text-xs mt-0.5" />
                                                                        <div>
                                                                            <div className="text-[9px] font-black uppercase tracking-widest text-slate-400">Roof Type</div>
                                                                            <div className="text-xs font-bold text-slate-700">{style.roof}</div>
                                                                        </div>
                                                                    </div>
                                                                    <div className="flex items-start gap-2 bg-slate-50 rounded-xl p-3">
                                                                        <i className="fa-solid fa-star text-slate-400 text-xs mt-0.5" />
                                                                        <div>
                                                                            <div className="text-[9px] font-black uppercase tracking-widest text-slate-400">Main Feature</div>
                                                                            <div className="text-xs font-bold text-slate-700">{style.mainFeature}</div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div className="border-t border-slate-100 px-6 py-4">
                                                                    <div className="text-[9px] font-black uppercase tracking-widest text-slate-400 mb-3">How to Identify</div>
                                                ...
                                                <table className="w-full text-sm">
                                                    ...
                                                    <tbody>
                                                        {COMPARISON_TABLE.map((row, i) => {
                                                            ...
                                                            return (
                                                                <tr key={row.style} className={`border-b border-slate-100 hover:bg-indigo-50/50 transition-colors ${i % 2 === 0 ? 'bg-white' : 'bg-slate-50/50'}`}>
                                                                    <td className="px-6 py-4">
                                                                        <div className="flex items-center gap-2">
                                                                            <div className={`w-2 h-2 rounded-full flex-shrink-0 ${dotColors[row.color]}`} />
