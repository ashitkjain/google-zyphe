...
const ClientHub: React.FC<Props> = ({ realtorId, realtorName, onSignOut, onBack, exploreContent, initialTab, onNavigate, onUpdateProfile: onUpdateProfileProp, userRole }) => {
    ...
    useEffect(() => {
        ...
        const PAGE_LABELS: Record<string, string> = {
            ...
            guides: 'Guides', city_data: 'City Ingestion', hamilton_ingest: 'Hamilton Ingestion', data_health: 'Data Health',
    ...
    const toolTabs: { id: HubTab; label: string; icon: string }[] = (isAuditor || isInvestor) ? [] : [
        ...
        { id: 'property_comps', label: 'Property Comps', icon: 'fa-chart-bar' },
    ...
    const adminTabs: { id: HubTab; label: string; icon: string }[] = isAdmin ? [
        ...
        { id: 'hamilton_ingest', label: 'Hamilton Ingestion', icon: 'fa-diagram-project' },
