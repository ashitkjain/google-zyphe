        ...
        <div className="flex items-center gap-3">
          <div className="flex items-center gap-2">
            ...
            {isFavorited && (
              <button
                onClick={onToggleFavorite}
                className="h-12 px-4 rounded-xl flex items-center justify-center gap-2 transition-all bg-white text-slate-400 border border-slate-200 hover:text-rose-500 hover:bg-rose-50 shadow-sm group"
