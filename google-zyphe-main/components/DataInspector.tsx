      ...
      <div className="relative w-full max-w-5xl bg-gray-900 rounded-[2rem] shadow-2xl overflow-hidden flex flex-col max-h-[90vh] border border-gray-800 animate-in zoom-in-95 duration-300">
        ...
        <div className="px-8 py-6 border-b border-gray-800 flex items-center justify-between bg-gray-900/50">
          ...
          <div className="flex items-center gap-3">
            <button 
              onClick={handleCopy}
              className="px-6 py-3 bg-indigo-600 hover:bg-indigo-700 text-white rounded-xl text-sm font-bold transition-all active:scale-95 flex items-center gap-2 shadow-md"
            >
            ...
            <button 
              ...
              className="px-6 py-3 bg-indigo-600 hover:bg-indigo-700 text-white rounded-xl text-sm font-bold transition-all active:scale-95 flex items-center gap-2 shadow-xl shadow-indigo-900/20"
            >
